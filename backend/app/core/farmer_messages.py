...
_TEMPLATES: dict[str, dict[str, str]] = {
    ...
    "extreme_heat_alert": {"en": "Very high temperatures are expected today. Consider extra irrigation and shade protection for heat-sensitive crops."},
    ...
    "DISPUTE_RESOLVED_REFUNDED": {"en": "Your dispute has been resolved with a refund of {amount}."},
    ...
    "TREATMENT_FOLLOWUP_REMINDER": {"en": "It's time to check on your crop's treatment follow-up, scheduled for {due_date}."},
    ...
    "daily_summary_crop_multi": {
        "en": "Crops: {crop_summary}.",
        "hi": "फसलें: {crop_summary}।",
        "te": "పంటలు: {crop_summary}.",
        "ta": "பயிர்கள்: {crop_summary}.",
        "kn": "ಬೆಳೆಗಳು: {crop_summary}.",
        "ml": "വിളകൾ: {crop_summary}.",
        "mr": "पिके: {crop_summary}.",
    },
    "daily_summary_weather_action": {
        "en": "Spray advisory: conditions do not look suitable for spraying right now.",
        "hi": "छिड़काव सलाह: अभी छिड़काव के लिए स्थितियाँ उपयुक्त नहीं लगतीं।",
        "te": "స్ప్రే సలహా: ప్రస్తుతం స్ప్రే చేయడానికి పరిస్థితులు అనుకూలంగా లేవు.",
        "ta": "தெளிப்பு ஆலோசனை: இப்போது தெளிப்பதற்கு நிலைமைகள் ஏற்றதாக இல்லை.",
        "kn": "ಸಿಂಪಡಣೆ ಸಲಹೆ: ಈಗ ಸಿಂಪಡಿಸಲು ಪರಿಸ್ಥಿತಿಗಳು ಸೂಕ್ತವಾಗಿ ಕಾಣುತ್ತಿಲ್ಲ.",
        "ml": "സ്പ്രേ ഉപദേശം: ഇപ്പോൾ തളിക്കാൻ സാഹചര്യങ്ങൾ അനുയോജ്യമല്ല.",
        "mr": "फवारणी सल्ला: सध्या फवारणीसाठी परिस्थिती योग्य दिसत नाही.",
    },
    "daily_summary_risk": {
