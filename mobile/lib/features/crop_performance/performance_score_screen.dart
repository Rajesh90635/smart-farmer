          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  score.insufficientData ? 'Insufficient data' : '${score.overallScore}/100',
                  style: const TextStyle(fontSize: 28, fontWeight: FontWeight.bold),
                ),
                const SizedBox(height: 4),
                Text('Data completeness: ${score.dataCompletenessPercent}%', style: const TextStyle(fontSize: 12, color: Colors.grey)),
              ],
            ),
          ),
        ),
        const SizedBox(height: 16),
        ...score.components.map(_buildComponentCard),
      ],
    );
  }

  Widget _buildComponentCard(PerformanceComponent component) {
    return Card(
      child: Padding(
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Text(
                  component.score != null ? '${component.score}' : 'Not available',
